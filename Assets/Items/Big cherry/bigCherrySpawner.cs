...
public class bigCherrySpawner : MonoBehaviour
{
    public GameObject bigCherry;
    public int count = 0;
    ...
    void Start()
    {
        ...
        InvokeRepeating("Spawn", 0f, 20f);
        InvokeRepeating("Spawn", 0f, 20f);
        InvokeRepeating("addBackToSpawnableItemList", 25f, 20f);
        InvokeRepeating("addBackToSpawnableItemList", 25f, 20f);
        InvokeRepeating("addBackToSpawnableItemList", 25f, 20f);
    }
    ...
    public void Spawn()
    {
        ...
        Instantiate(bigCherry, new Vector3(spawnableItemCell[v].x, spawnableItemCell[v].y - 1, spawnableItemCell[v].z), Quaternion.Euler(new Vector3(-90, Random.Range(0, 360f), 0)));
        //remove at v
